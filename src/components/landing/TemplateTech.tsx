...
export default function TemplateTech({ product, merchant, config }: { product: Product; merchant: Merchant; config: Config }) {
  ...
  return (
    <div className="min-h-screen bg-[#0B0B0C] text-[#EDEDED]">
      ...
      <section className="grid lg:grid-cols-[1.05fr_0.95fr] min-h-[82vh] border-b border-white/10">
        <div className="px-5 lg:px-12 py-10 lg:py-16 flex flex-col justify-center">
          ...
          <h1 className="text-[12vw] lg:text-[5.4vw] leading-[0.88] tracking-[-0.06em] font-bold uppercase">
            <span className="block overflow-hidden"><span className="block">{t1}</span></span>
            <span className="block overflow-hidden"><span className="block" style={{ WebkitTextStroke: "1px rgba(255,255,255,0.28)", color: "transparent" }}>{t2}</span></span>
          </h1>
      ...
      <section id="order" className="max-w-[1280px] mx-auto border-x border-white/10 grid lg:grid-cols-2">
