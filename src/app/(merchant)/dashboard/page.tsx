  ...
  return (
    <div className="space-y-6 animate-in">
      ...
      <div className="grid md:grid-cols-4 gap-4">
        <div className="group relative overflow-hidden bg-card rounded-[20px] border border-border p-5 hover:shadow-lg hover:border-border-strong transition-all duration-300 hover:-translate-y-0.5">
          <div className="absolute top-0 inset-x-0 h-[3px] bg-gradient-to-r from-violet-500 to-indigo-500" />
          <div className="flex justify-between items-start">
            <div className="w-10 h-10 rounded-xl bg-violet-50 dark:bg-violet-500/15 text-violet-600 flex items-center justify-center group-hover:scale-110 transition-transform">
            ...
            <span className="text-xs font-bold bg-emerald-50 dark:bg-emerald-500/15 text-emerald-600 px-2 py-1 rounded-full">+12% ↑</span>
          </div>
        ...
        <div className="group relative overflow-hidden bg-card rounded-[20px] border border-border p-5 hover:shadow-lg hover:border-border-strong transition-all duration-300 hover:-translate-y-0.5">
          ...
          <div className="flex justify-between items-start">
            <div className="w-10 h-10 rounded-xl bg-amber-50 dark:bg-amber-500/15 text-amber-600 flex items-center justify-center group-hover:scale-110 transition-transform">
            ...
            <span className="text-xs font-bold bg-amber-50 dark:bg-amber-500/15 text-amber-700 px-2 py-1 rounded-full">بانتظار</span>
          </div>
        ...
        <div className="group relative overflow-hidden bg-card rounded-[20px] border border-border p-5 hover:shadow-lg hover:border-border-strong transition-all duration-300 hover:-translate-y-0.5">
          ...
          <div className="flex justify-between items-start">
            <div className="w-10 h-10 rounded-xl bg-emerald-50 dark:bg-emerald-500/15 text-emerald-600 flex items-center justify-center group-hover:scale-110 transition-transform">
              <svg viewBox="0 0 24 24" className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth={2}><path d="M5 13l4 4L19 7" /></svg>
            </div>
            <span className="text-xs font-bold bg-emerald-50 dark:bg-emerald-500/15 text-emerald-700 px-2 py-1 rounded-full">✓ جاهز للشحن</span>
          </div>
        ...
        <div className="group relative overflow-hidden bg-card rounded-[20px] border border-border p-5 hover:shadow-lg hover:border-border-strong transition-all duration-300 hover:-translate-y-0.5">
          ...
          <div className="flex justify-between items-start">
            <div className="w-10 h-10 rounded-xl bg-red-50 dark:bg-red-500/15 text-red-600 flex items-center justify-center group-hover:scale-110 transition-transform">
            ...
            <span className="text-xs font-bold bg-red-50 dark:bg-red-500/15 text-red-600 px-2 py-1 rounded-full">محمي</span>
          </div>
      ...
      <div className="grid lg:grid-cols-3 gap-4">
        <div className="lg:col-span-2 relative overflow-hidden rounded-[20px] bg-ink text-white dark:bg-white dark:text-zinc-900 p-6 shadow-lg">
          ...
          <div className="relative flex justify-between items-start">
            ...
            <div className="hidden sm:flex items-center gap-2 bg-white/10 dark:bg-zinc-900/10 backdrop-blur rounded-full px-3 py-1.5 text-xs font-bold">
          ...
          <div className="mt-6 flex items-end gap-1.5 h-12">
            {[35, 55, 40, 70, 60, 85, 50, 75, 65, 90, 70, 80].map((h, i) => (
              <div key={i} className="flex-1 bg-white/20 dark:bg-zinc-900/15 rounded-t-lg" style={{ height: `${h}%` }} />
            ))}
          </div>
        ...
        <div className="space-y-4">
          <div className="bg-card rounded-[20px] border border-border p-5 hover:shadow-md transition-shadow">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-emerald-50 dark:bg-emerald-500/15 text-emerald-600 flex items-center justify-center">
          ...
          <div className="bg-card rounded-[20px] border border-border p-5 hover:shadow-md transition-shadow">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-violet-50 dark:bg-violet-500/15 text-violet-600 flex items-center justify-center">
              ...
              <Link href="/dashboard/products" className="ms-auto text-xs bg-ink text-white dark:bg-white dark:text-zinc-900 px-3 py-1.5 rounded-full font-bold hover:opacity-90">إضافة →</Link>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="divide-y divide-border">
          {recentOrders && recentOrders.length ? recentOrders.map((o) => (
            <div key={o.id} className="px-6 py-4 flex items-center gap-4 hover:bg-card-hover/50 transition-colors group">
              <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-zinc-900 to-zinc-700 dark:from-zinc-700 dark:to-zinc-600 text-white flex items-center justify-center font-black text-sm shrink-0 group-hover:scale-105 transition-transform">{o.customer_name[0]}</div>
              ...
              <span className={`hidden sm:inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-bold border ${o.confirmation_status === "fake" ? "bg-red-50 dark:bg-red-500/10 text-red-700 dark:text-red-300 border-red-200 dark:border-red-500/20" : o.confirmation_status === "confirmed" ? "bg-emerald-50 dark:bg-emerald-500/10 text-emerald-700 dark:text-emerald-300 border-emerald-200 dark:border-emerald-500/20" : o.confirmation_status === "double" ? "bg-orange-50 dark:bg-orange-500/10 text-orange-600 border-orange-200" : "bg-amber-50 dark:bg-amber-500/10 text-amber-700 border-amber-200"}`}>
              ...
              <Link href={`/dashboard/orders/${o.id}`} className="p-2 rounded-xl bg-background border border-border group-hover:bg-ink group-hover:text-white dark:group-hover:bg-white dark:group-hover:text-zinc-900 transition-colors">
                <svg viewBox="0 0 24 24" className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth={1.8}><path d="M9 5l7 7-7 7" /></svg>
              </Link>
            </div>
          )) : <div className="p-12 text-center">
            <div className="w-14 h-14 rounded-2xl bg-background border border-border flex items-center justify-center mx-auto mb-3">📦</div>
